					...
					do{
						...
						switch(menu2){
							...
							case 2://Crear petici�n de certificado.
								System.out.println("Escriba nombre al fichero para la petición de certificación:");
								fichero= sc.next();
								//COMPLETAR POR EL ESTUDIANTE
							...
							case 3://Verificar certificado externo.
								...
								if(u.verificarCertificadoExterno(ficheroCA, fichero)) {
									System.out.println("*****Verificación de Certificado Correcta*****");
								}else {
									System.out.println("*****Verificación de Certificado Incorrecta*****");
								}
						...
						switch(menu2){
							...
							case 3:// Generar certificado a partir de una petici�n
								    ...
								    if(ca.certificarPeticion(fichero, ficheroCertUsu)) {
								    	System.out.println("Certificado creado a partir de peticion de usuario");
								    }else {
								        System.out.println("No se ha podido crear certificado con la petición");	
								    }
